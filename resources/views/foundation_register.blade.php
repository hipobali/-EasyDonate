                    ...
                    <form method="post" action="{{route('foundation_register')}}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ old('email') }}" placeholder="........@gmail.com" type="text" name="email" id="email" class="form-control form-control-sm {{$errors->has('email') ? 'has-error':''}}">
                                <span class="text-danger">{{$errors->first('email')}}</span>
                            </div>
                            <div class="form-group">
                                <label for="address"><span class="fa fa-home"></span>&nbsp Address: </label>
                                <textarea value="{{ old('address') }}" type="text" id="address" name="address" class="form-control form-control-sm {{$errors->has('address') ? 'has-error':''}}" ></textarea>
                                <span class="text-danger">{{$errors->first('address')}}</span>
                            </div>
                            <div class="form-group">
                                <label for="phone"><span class="fa fa-phone"></span>&nbsp Foundation Phone:</label>
                                <input value="{{ old('phone') }}" type="text" id="phone" name="phone" placeholder="09*********" class="form-control form-control-sm {{$errors->has('phone') ? 'has-error':''}}">
                                <span class="text-danger">{{$errors->first('phone')}}</span>
                            </div>
                            <div class="form-group">
                                <label for="president_name"><span class="fa fa-user"></span> &nbsp President Name:</label>
                                <input value="{{ old('president_name') }}" type="text" id="president_name" name="president_name" class="form-control form-control-sm {{$errors->has('president_name') ? 'has-error':''}}">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ old('foundation_certificate') }}" type="file" id="foundation_certificate" name="foundation_certificate" class="certificate_file form-control form-control-sm {{$errors->has('foundation_certificate') ? 'has-error':''}}">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ old('member_count') }}" type="number" id="member_count" name="member_count" class="form-control {{$errors->has('member_count') ? 'has-error':''}}">
                                <span class="text-danger">{{$errors->first('member_count')}}</span>
                            </div>
                            <div class="form-group">
                                <label id="password"><span class="fa fa-key"></span> &nbsp Password: </label>
                                <input value="{{ old('password') }}" type="password" id="password"  name="password" class="form-control form-control-sm {{$errors->has('password') ? 'has-error':''}}">
                                <span class="text-danger">{{$errors->first('password')}}</span>
                            </div>
                            <div class="form-group">
                                <label id="confirm_password"><span class="fa fa-key"></span> &nbspConfirm Password: </label>
                                <input value="{{ old('confirm_password') }}" type="password" id="password"  name="confirm_password" class="form-control form-control-sm {{$errors->has('confirm_password') ? 'has-error':''}}">
